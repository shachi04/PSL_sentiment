...
writefolder = System.getProperty("user.home") + "/Documents/Shachi/CMPS209C/reviews/Results/psl_mln_wtlearn/"
File file3 = new File(writefolder+"results.csv");
filename4 = writefolder+ "auc.csv"
...
filename1 = writefolder+"fold"+folder+"/possentiment.csv"
filename2 = writefolder+"fold"+folder+"/negsentiment.csv"
