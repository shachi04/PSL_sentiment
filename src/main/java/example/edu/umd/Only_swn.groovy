...
//
		 ...
		 * 
		 */
		m.add rule : (prev(A,B) &  ~contrast(A,B) & possentiment(B)) >> possentiment(A), weight :5, squared : false
		m.add rule : (prev(A,B) &  ~contrast(A,B) & negsentiment(B)) >> negsentiment(A), weight :5, squared : false
